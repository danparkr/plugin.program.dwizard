...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = 'dacno5[COLOR limegreen][B]5[/B][/COLOR]'
BUILDERNAME = 'dacno5'
...
THEME1 = u'[COLOR {color1}][I](dacno[COLOR {color1}][B]5[/B][/COLOR][COLOR {color2}][COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing DMP - DWizard.\n\nContact us on Github at http://www.github.com/danparkr/plugin.program.dwizard/'
...
REPOADDONXML = 'https://raw.githubusercontent.com/danparkr/repository.dwizard/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/danparkr/repository.dwizard/master/zips/repository.dwizard/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = 'dacno[COLOR limegreen][B]5[/B][/COLOR]'
